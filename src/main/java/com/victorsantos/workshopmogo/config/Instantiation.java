...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args0) throws Exception {
		...
		Post mariaBrown = new Post(null,sdf.parse("21/03/2018") , "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
		Post mariaBrown1 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!", maria);
